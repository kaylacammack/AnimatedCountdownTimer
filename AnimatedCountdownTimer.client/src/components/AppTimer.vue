    ...
    <div class="root">
        <svg class="svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <g class="circle">
                ...
                <path class="time-left-path" v-if="timeLeft > 0" d="
                    m 50, 50 
                    m -45, 0 
                    a 45,45 0 1,0 90,0 
                    a 45,45 0 1,0 -90,0
                    " :style="{ strokeDasharray }"></path>
            </g>
        </svg>
...
export default {
    ...
    computed: {
        ...
        strokeDasharray() {
            ...
            const elapsedDash = Math.floor(timeFraction * total);
...
.time-left-path {
    ...
    /*Once second aligns with the speed of the countdown timer */
